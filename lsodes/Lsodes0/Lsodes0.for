...
c-----------------------------------------------------------------------
 ...
 280  if ((tn + h) .ne. tn) go to 290
     ...
     1   50, 101, 0, 0, 0, 0, 2, tn, h)
      ...
      call xerrwv("lsodes-- above warning has been issued i1 times.  2",
